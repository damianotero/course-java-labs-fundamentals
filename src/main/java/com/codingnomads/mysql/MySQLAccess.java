package com.codingnomads.mysql;
...
public class MySQLAccess {
    ...
    public void readDataBase(String course_name, int units) throws Exception {
        try {
            ...
            Class.forName("com.com.codingnomads.mysql.jdbc.Driver");
            // Setup the connection with the DB
            connection = DriverManager.getConnection("jdbc:com.codingnomads.mysql://localhost/University?" +
            ...
            List<Course> course = mapResultSetToObjects(resultSet);
            ...
            preparedStatement = connection.prepareStatement("insert into  University.courses (name, units) values (?, ?)");
            ...
            preparedStatement = connection.prepareStatement("SELECT * from University.courses");
    ...
    private List<Course> mapResultSetToObjects(ResultSet resultSet) throws SQLException {
